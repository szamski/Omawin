...
function Set-RegistryValue {
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to set $Description : $(# Note: This script should be run as Administrator for full functionality
...
Write-ColorOutput "  â€˘ Some features (like Cortana) may still appear but will be non-functional" "Gray"
Write-ColorOutput "  â€˘ Windows Security and Windows Update remain enabled for your safety" "Gray"
...
function Disable-ScheduledTask {
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to disable task $TaskName : $(# Note: This script should be run as Administrator for full functionality
...
function Stop-TelemetryService {
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to disable service $ServiceName : $(# Note: This script should be run as Administrator for full functionality
