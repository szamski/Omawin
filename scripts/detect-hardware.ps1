...
function Get-GPUInfo {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting GPU: $(# Note: This script should be run as Administrator for full functionality
...
function Get-GPUInfo {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting GPU: $_" "Red"
        return @()
    }
}
...
function Get-CPUInfo {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting CPU: $_" "Red"
        return $null
    }
}
...
function Get-AudioDevices {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting audio devices: $_" "Red"
        return @()
    }
}
...
function Get-NetworkAdapters {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting network adapters: $_" "Red"
        return @()
    }
}
...
function Get-SystemInfo {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting system info: $_" "Red"
        return $null
    }
}
...
function Get-StorageDevices {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting storage devices: $_" "Red"
        return @()
    }
}
...
try {
    ...
    Write-ColorOutput "`nX Failed to export hardware info: $_" "Red"
}
...
function Get-CPUInfo {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting CPU: $(# Note: This script should be run as Administrator for full functionality
...
function Get-AudioDevices {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting audio devices: $(# Note: This script should be run as Administrator for full functionality
...
function Get-NetworkAdapters {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting network adapters: $(# Note: This script should be run as Administrator for full functionality
...
function Get-SystemInfo {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting system info: $(# Note: This script should be run as Administrator for full functionality
...
function Get-StorageDevices {
    ...
    try {
        ...
        Write-ColorOutput "  X Error detecting storage devices: $(# Note: This script should be run as Administrator for full functionality
...
try {
    ...
    Write-ColorOutput "`nX Failed to export hardware info: $(# Note: This script should be run as Administrator for full functionality
