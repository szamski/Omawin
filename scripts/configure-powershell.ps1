...
'@
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to create profile: $(# Note: This script should be run as Administrator for full functionality
...
function Install-PSReadLine {
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to install PSReadLine: $(# Note: This script should be run as Administrator for full functionality
...
'@
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to create Starship config: $(# Note: This script should be run as Administrator for full functionality
