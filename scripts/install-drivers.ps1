...
function Install-DriverPackage {
    ...
    try {
        ...
        Write-ColorOutput "  X Error installing $PackageName driver: $(# Note: This script should be run as Administrator for full functionality
...
function Invoke-WindowsUpdate {
    ...
    try {
        ...
        Write-ColorOutput "  ! Could not run Windows Update automatically: $(# Note: This script should be run as Administrator for full functionality
...
try {
    ...
    Write-ColorOutput "Failed to load hardware information: $(# Note: This script should be run as Administrator for full functionality
