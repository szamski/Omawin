...
function Add-ToPath {
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to add $PathToAdd to $Scope PATH: $(# Note: This script should be run as Administrator for full functionality
...
function Set-CustomEnvironmentVariable {
    ...
    try {
        ...
        Write-ColorOutput "  X Failed to set $Name : $(# Note: This script should be run as Administrator for full functionality
...
try {
    ...
    Write-ColorOutput "  X Failed to refresh environment: $(# Note: This script should be run as Administrator for full functionality
